...
const Home = () => {
  ...
  const industrialInsights = {
    ...
    "Vocational Excellence": "The DRRG 'Elite Skills' Vocational Framework is built on the pillars of 'Precision, Speed, and Technical Mastery.' Recognized under national and international skill development standards (NSDC), our vocational tracks are designed for individuals who demand high-velocity career entry.",
    "Download Section": "Our Digital Institutional Dossier is a comprehensive guide that provides a microscopic view into the educational ecosystem of DRRG Academy. This is not just a brochure; it is a repository of technical data, including: (1) Curriculum Blueprints (2) Infrastructure Audits (3) Faculty Matrix (4) Placement Analytics.",
    "Industry Intelligence": "The DRRG 'Career Command Center' (CCC) provides a transparent, real-time interface for tracking the professional trajectory of our alumni network. This tracker aggregates data from our 100+ global hiring partners across the aviation, hospitality, healthcare, and corporate sectors.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between mb-10 gap-4 text-center md:text-left">
            <div>
              ...
              <p className="text-brand-100 mt-2">Specialized institutions under the DRRG umbrella.</p>
            </div>
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-slate-900 mb-6">
            Take the next step toward your goals with <span className="text-brand-700">DRRG Academy.</span>
          </h2>
